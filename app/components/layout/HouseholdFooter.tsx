  ...
  return (
    <div className="mt-auto flex flex-col gap-2.5">
      ...
      {users.map((user, index) => {
        ...
        // Only your own row links anywhere — a shortcut into /settings'
        // personal-preferences card, not a way to jump to another
        // member's data (there isn't one — preferences are self-service).
